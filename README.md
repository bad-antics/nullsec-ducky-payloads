...
|----------|-------|-------------|
| 🔍 **Recon** | 10 | System enumeration, network discovery |
| 📤 **Exfil** | 10 | WiFi creds, browser data, SSH keys |
| 🔐 **Persistence** | 10 | Reverse shells, scheduled tasks |
| 🎭 **Pranks** | 10 | Wallpaper, voice, keyboard chaos |
| ☁️ **Cloud/DevOps** | 10 | AWS, Azure, Docker, K8s, Terraform |
...
| Project | Description |
|---------|-------------|
| **[Bunny Payloads](https://github.com/bad-antics/nullsec-bunny-payloads)** | Bash Bunny scripts |
| **[Flipper Zero](https://github.com/bad-antics/nullsec-flipper)** | Flipper BadUSB |
| **[NullSec](https://github.com/bad-antics/nullsec)** | Main framework |
